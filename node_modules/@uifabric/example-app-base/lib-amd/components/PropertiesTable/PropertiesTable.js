...
define(["require", "exports", "react", "office-ui-fabric-react/lib/Utilities", "office-ui-fabric-react/lib/DetailsList", "office-ui-fabric-react/lib/Selection", "../../utilities/parser/index", "./PropertiesTable.scss"], function (require, exports, React, Utilities_1, DetailsList_1, Selection_1, index_1) {
    "use strict";
    ...
    var PropertiesTable = (function (_super) {
        ...
        function PropertiesTable(props) {
            ...
            var properties = props.properties
                .sort(function (a, b) { return (a.interfacePropertyType < b.interfacePropertyType ? -1 :
                a.interfacePropertyType > b.interfacePropertyType ? 1 :
                    a.name < b.name ? -1 :
                        a.name > b.name ? 1 :
                            0); })
                .map(function (prop, index) { return Utilities_1.assign({}, prop, { key: index }); });
            var groups = null;
